...
;
t2 = t2 + '<td data-row="2" data-col="'+ttlcol +'" class="width100">Actual Cost</td><td  class="width100" data-row="2" data-col="'+(ttlcol + 1)+'">Average Cost</td><td  class="width60" data-row="2" data-col="'+(ttlcol + 2)+'">Boxes</td><td class="width60" data-row="2" data-col="'+(ttlcol + 3)+'">Pallets</td><td class="width90" data-row="2" data-col="'+(ttlcol + 4)+'">Ttl Weight</td></tr>';
				table = table  + t1;
				table = table + t2;
				table = table + titems;
