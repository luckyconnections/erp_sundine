...
table = table + '<td data-row="0" data-col="'+dataCol1 +'"><a href="javascript:;" class="delCol" onClick="salesTable_DelCol('+ dataCol1 +')"></a></td>';
	...
	tlCols = tlCols + '<td data-row="'+ (TableArray.length + 2) +'" data-col="'+ dataCol1 +'"><p id="qtotal" class="qtotal'+ dataCol1 +'">0</p><p id="stotal" class="stotal'+ dataCol1 +'">0.0</p></td>';		ttlcol  = colStart + k;
			...
			dataCol1 = dataCol1 + 1;			
					...
					titems = titems  + '<td data-row="'+dataRow +'" data-col="'+dataCol1+'"><span class="qtytotal">0.0</span></td></tr>';
		
		dataCol1 = 4;
		dataCol  = dataCol + 1;	
		dataRow = dataRow + 1;		
				}
				table  = table + ' <td data-row="0" data-col="'+ttlcol +'"></tr>';
				
t1 = t1 + '<td data-row="1" data-col="'+ttlcol +'"></tr>'
;
t2 = t2 + '<td data-row="2" data-col="'+ttlcol +'" class="width60">Boxes</td></tr>';
				table = table  + t1;
				table = table + t2;
				table = table + titems;
table = table + '<tr class="item-row" data-row="'+dataRow+'"><td data-row="'+dataRow+'" data-col="0"></td><td data-row="'+dataRow+'" data-col="1"></td><td data-row="'+dataRow+'" data-col="2"></td><td data-row="'+dataRow+'" data-col="3"></td>'+tlCols+'<td data-row="'+dataRow+'" data-col="'+ ttlcol + '"><span class="qtytotal_total"></span></td></tr>';
